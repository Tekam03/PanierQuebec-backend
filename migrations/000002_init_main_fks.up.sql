...
ALTER TABLE external_products ADD CONSTRAINT fk_external_products_matched_specific_product_id FOREIGN KEY (matched_specific_product_id) REFERENCES specific_products (id);

...
func (s *service) Create(ctx context.Context, m *merchant.MerchantCreate) (*model.StoreMerchant, error) {
    return s.repo.Create(ctx, m)
}

func (s *service) Patch(ctx context.Context, id int32, patch *merchant.MerchantPatch) (*model.StoreMerchant, error) {
